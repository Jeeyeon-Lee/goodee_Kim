package aquiz.step1;
// 흐름을 바꾸는 코드 - 관심
//MVC패턴를 적용한 게시판에서 업무의 특성상 트랜잭션처리가 필요할때
//Model계층에서 조건에 따라 하나의 업무로 규정되어 둘 다 처리되었을 때만 커밋하고 
//어느 하나라도 문제가 발생되면 모두 롤백해야 하는 경우에 그 시점을 인터셉트 할 목적(관여하기 위해서- 흐름을 바꾼다)으로 사용될 수 도 있다.
